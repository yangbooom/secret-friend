...
import {
  List, ListItem, ListItemText, Divider, Typography, Button,
  ...
  <div>
    ...
    <List style={styles.nav}>
      <Link to="/home/ratinol">
        ...
        <ListItem button>
          <ListItemText primary={<Typography style={{ textAlign: 'center', fontSize: '14px' }}>Ratinol</Typography>} />
        </ListItem>
      </Link>
      <Divider />
      <Link to="/home/burgerking">
        ...
        <ListItem button>
          <ListItemText primary={<Typography style={{ textAlign: 'center', fontSize: '14px' }}>Burger King</Typography>} />
        </ListItem>
      </Link>
      <Divider />
      <Link to="/home/chinese">
        ...
        <ListItem button>
          <ListItemText primary={<Typography style={{ textAlign: 'center', fontSize: '14px' }}>Chinese</Typography>} />
        </ListItem>
      </Link>
      <Divider />
      <Link to="/home/cobaco">
        ...
        <ListItem button>
          <ListItemText primary={<Typography style={{ textAlign: 'center', fontSize: '14px' }}>Cobaco</Typography>} />
        </ListItem>
      </Link>
